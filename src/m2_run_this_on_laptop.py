...
def get_shared_frames(main_frame, mqtt_sender):
    ...
    ir_frame = shared_gui.ir_frame(main_frame,mqtt_sender)

    return teleop_frame, arm_frame, control_frame, drive_system_frame, beep_frame, ir_frame


def grid_frames(teleop_frame, arm_frame, control_frame, drive_system_frame, beep_frame, ir_frame):
    teleop_frame.grid(row=0, column=0)
    arm_frame.grid(row=1, column=0)
    control_frame.grid(row=2, column=0)
    drive_system_frame.grid(row=0, column=1)
    beep_frame.grid(row=1, column=1)
    ir_frame.grid(row=3,column=0)
